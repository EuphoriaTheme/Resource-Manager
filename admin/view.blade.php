                ...
                <div class="box-body">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <input id="rm-search" type="text" class="form-control" placeholder="Filter by filename..." style="width: 100%;">
                        </div>
...
#rm-extension .rm-toast.success { background-color: #28a745; }
#rm-extension .rm-toast.error { background-color: #dc3545; }
</style>
